...
#include "VuxMockFl/Demo/_5T_InsideIO.cpp.h"
#include "VuxMock/Demo/_5T_InsideIO.cpp"

CInsideIO::CInsideIO()
{__VUFNID__(945); VuxDbgBrkO() 
{
...
///////////////////////////////////////////////*/
BOOL CInsideIO::GetTemperature(int* pTemperature)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"int*","pTemperature",(const void*)&pTemperature}}; if(VuxMckM("GetTemperature",&vmckrt,vmckds,1,"CInsideIO",955,4,1)) return *(BOOL*)vmckrt;{__VUFNINFO__("GetTemperature","BOOL",955); VuxDbgBrkO() 
{
...
///////////////////////////////////////////////*/
BOOL CInsideIO::_01_WorkTime(int* pWorkTime)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"int*","pWorkTime",(const void*)&pWorkTime}}; if(VuxMckM("_01_WorkTime",&vmckrt,vmckds,1,"CInsideIO",946,12,1)) return *(BOOL*)vmckrt;{__VUFNINFO__("_01_WorkTime","BOOL",946); VuxDbgBrkO() 
{
...
返回: int类型，打击效果
///////////////////////////////////////////////*/
int CInsideIO::_02_PowerEffect(bool reset)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"bool","reset",(const void*)&reset}}; if(VuxMckM("_02_PowerEffect",&vmckrt,vmckds,1,"CInsideIO",947,8,1)) return *(int*)vmckrt;{__VUFNINFO__("_02_PowerEffect","int",947); VuxDbgBrkO() 
{   
...
返回: 无
///////////////////////////////////////////////*/
void CInsideIO::_03_UpdateUserNameOrPassword()
{if(!VuxMckM("_03_UpdateUserNameOrPassword",0,0,0,"CInsideIO",948,15,1)) {__VUFNID__(948); VuxDbgBrkO() 
{
...
演示局部输入(替换选中代码)
///////////////////////////////////////////////*/
int CInsideIO::_04_LocalInput1(int index, int arg)
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"int","index",(const void*)&index},{2,"int","arg",(const void*)&arg}}; if(VuxMckM("_04_LocalInput1",&vmckrt,vmckds,2,"CInsideIO",949,6,1)) return *(int*)vmckrt;{__VUFNINFO__("_04_LocalInput1","int",949); VuxDbgBrkO() 
{
...
演示局部输入(插入赋值语句)
///////////////////////////////////////////////*/
int CInsideIO::_05_LocalInput2(int arg)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"int","arg",(const void*)&arg}}; if(VuxMckM("_05_LocalInput2",&vmckrt,vmckds,1,"CInsideIO",950,4,1)) return *(int*)vmckrt;{__VUFNINFO__("_05_LocalInput2","int",950); VuxDbgBrkO() 
{   
...
模拟中断对全局变量的修改
///////////////////////////////////////////////*/
int CInsideIO::_06_Interrupt(int arg)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"int","arg",(const void*)&arg}}; if(VuxMckM("_06_Interrupt",&vmckrt,vmckds,1,"CInsideIO",951,3,1)) return *(int*)vmckrt;{__VUFNINFO__("_06_Interrupt","int",951); VuxDbgBrkO() 
{   
...
{void* vmckrt=0; if(VuxMckM("_07_LoopEver",&vmckrt,0,0,"CInsideIO",952,8,1)) return *(int*)vmckrt;{__VUFNINFO__("_07_LoopEver","int",952); VuxDbgBrkO() 
{   
...
///////////////////////////////////////////////*/
void CInsideIO::_08_call_sub_test(int a)
{VMCKDS vmckds[1]={{1,"int","a",(const void*)&a}}; if(!VuxMckM("_08_call_sub_test",0,vmckds,1,"CInsideIO",953,4,1)) {__VUFNID__(953); VuxDbgBrkO() 
{
...
底层输入，多次调用同一底层函数的处理
///////////////////////////////////////////////*/
int CInsideIO::_09_mul_call_test()
{void* vmckrt=0; if(VuxMckM("_09_mul_call_test",&vmckrt,0,0,"CInsideIO",954,13,1)) return *(int*)vmckrt;{__VUFNINFO__("_09_mul_call_test","int",954); VuxDbgBrkO() 
{
...
#include "VuxConn/Demo/_5T_InsideIO.cpp.h"
