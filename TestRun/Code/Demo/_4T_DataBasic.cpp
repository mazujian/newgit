...
#include "VuxMockFl/Demo/_4T_DataBasic.cpp.h"
#include "VuxMock/Demo/_4T_DataBasic.cpp"

/* ////////////////////////////////////////////// 
数据表格：最基本的数据
///////////////////////////////////////////////*/
int _01_Ansi(int i, char ch, float fl, char* str)
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"int","i",(const void*)&i},{2,"char","ch",(const void*)&ch},{3,"float","fl",(const void*)&fl},{4,"char*","str",(const void*)&str}}; if(VuxMck("_01_Ansi",&vmckrt,vmckds,4,"",915,1,9)) return *(int*)vmckrt;{__VUFNINFO__("_01_Ansi","int",915); VuxDbgBrkO() 
{
...
数据表格：最基本的数据， UNICODE
///////////////////////////////////////////////*/
short _02_Unicode(short sh, WCHAR wch, double dl, unsigned short* wstr)
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"short","sh",(const void*)&sh},{2,"WCHAR","wch",(const void*)&wch},{3,"double","dl",(const void*)&dl},{4,"unsigned short*","wstr",(const void*)&wstr}}; if(VuxMck("_02_Unicode",&vmckrt,vmckds,4,"",1040,1,9)) return *(short*)vmckrt;{__VUFNINFO__("_02_Unicode","short",1040); VuxDbgBrkO() 
{
...
数据表格：结构指针
///////////////////////////////////////////////*/
BASE* _03_Struct(BASE* pBase)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"BASE*","pBase",(const void*)&pBase}}; if(VuxMck("_03_Struct",&vmckrt,vmckds,1,"",917,1,9)) return *(BASE**)vmckrt;{__VUFNINFO__("_03_Struct","BASE*",917); VuxDbgBrkO() 
{
...
数据表格：复杂一些的结构指针
///////////////////////////////////////////////*/
BASE* _04_Struct2(DATA* pData)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"DATA*","pData",(const void*)&pData}}; if(VuxMck("_04_Struct2",&vmckrt,vmckds,1,"",918,1,9)) return *(BASE**)vmckrt;{__VUFNINFO__("_04_Struct2","BASE*",918); VuxDbgBrkO() 
{
...
数据表格：数组
///////////////////////////////////////////////*/
int _05_Array(int i[10], char ch[10], float fl[10], char* str[10])
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"int[10]","i",(const void*)i},{2,"char[10]","ch",(const void*)ch},{3,"float[10]","fl",(const void*)fl},{4,"char*[10]","str",(const void*)str}}; if(VuxMck("_05_Array",&vmckrt,vmckds,4,"",919,1,9)) return *(int*)vmckrt;{__VUFNINFO__("_05_Array","int",919); VuxDbgBrkO() 
{
...
数据表格：结构指针数组
///////////////////////////////////////////////*/
BASE* _06_Array2(DATA* pDatas[10])
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"DATA*[10]","pDatas",(const void*)pDatas}}; if(VuxMck("_06_Array2",&vmckrt,vmckds,1,"",920,2,1)) return *(BASE**)vmckrt;{__VUFNINFO__("_06_Array2","BASE*",920); VuxDbgBrkO() 
{; VUXRS(1);
...
数据表格：利用->指定多级指针为NULL
///////////////////////////////////////////////*/
int _07_Pointer(int a, int* pa, int** ppa, int*** pppa)
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"int","a",(const void*)&a},{2,"int*","pa",(const void*)&pa},{3,"int**","ppa",(const void*)&ppa},{4,"int***","pppa",(const void*)&pppa}}; if(VuxMck("_07_Pointer",&vmckrt,vmckds,4,"",921,15,1)) return *(int*)vmckrt;{__VUFNINFO__("_07_Pointer","int",921); VuxDbgBrkO() 
{
...
///////////////////////////////////////////////*/
BASE* _08_Pointer2(DATA* pData)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"DATA*","pData",(const void*)&pData}}; if(VuxMck("_08_Pointer2",&vmckrt,vmckds,1,"",922,3,1)) return *(BASE**)vmckrt;{__VUFNINFO__("_08_Pointer2","BASE*",922); VuxDbgBrkO() 
{
    if( VUXRS(1)&&(pData == 0))
    {{ 
...
数据表格：为指针建立空对象
///////////////////////////////////////////////*/
int _09_EmptyObject(BASE* pData, CList<BASE*, BASE*>* pList)
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"BASE*","pData",(const void*)&pData},{2,"CList<BASE*,BASE*>*","pList",(const void*)&pList}}; if(VuxMck("_09_EmptyObject",&vmckrt,vmckds,2,"",923,6,1)) return *(int*)vmckrt;{__VUFNINFO__("_09_EmptyObject","int",923); VuxDbgBrkO() 
{
    if( VUXRS(1)&&(pData != 0))
    {{
 VUXRS(2);        pData->a = 123;
 VUXRS(3);        pData->f = (float)123.456;
    }}
...
数据表格：类型重设
///////////////////////////////////////////////*/
char* _10_TypeReset(void* pData, char** strs)
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"void*","pData",(const void*)&pData},{2,"char**","strs",(const void*)&strs}}; if(VuxMck("_10_TypeReset",&vmckrt,vmckds,2,"",924,1,9)) return *(char**)vmckrt;{__VUFNINFO__("_10_TypeReset","char*",924); VuxDbgBrkO() 
{
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"MYSDATA*","pMyData",(const void*)&pMyData}}; if(VuxMck("_11_CallScript",&vmckrt,vmckds,1,"",925,7,1)) return *(int*)vmckrt;{__VUFNINFO__("_11_CallScript","int",925); VuxDbgBrkO() 
{
    //应用address1
...
返回: 调用函数指针后的结果
///////////////////////////////////////////////*/
int _12_FunctionPtr(int a, int b, MYFUNC pFunc, int (*pFunc2)(int a, int b))
{void* vmckrt=0; VMCKDS vmckds[4]={{1,"int","a",(const void*)&a},{2,"int","b",(const void*)&b},{3,"MYFUNC","pFunc",(const void*)&pFunc},{4,"int(*)(int a,int b)","pFunc2",(const void*)&pFunc2}}; if(VuxMck("_12_FunctionPtr",&vmckrt,vmckds,4,"",926,12,1)) return *(int*)vmckrt;{__VUFNINFO__("_12_FunctionPtr","int",926); VuxDbgBrkO() 
{
...
///////////////////////////////////////////////*/
int _12_VariablePtr(int* item, int* items, int count)
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"int*","item",(const void*)&item},{2,"int*","items",(const void*)&items},{3,"int","count",(const void*)&count}}; if(VuxMck("_12_VariablePtr",&vmckrt,vmckds,3,"",1147,13,1)) return *(int*)vmckrt;{__VUFNINFO__("_12_VariablePtr","int",1147); VuxDbgBrkO() 
{
...
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"int","a",(const void*)&a},{2,"int","b",(const void*)&b}}; if(VuxMck("_13_NumberPointer",&vmckrt,vmckds,2,"",927,81,1)) return *(int*)vmckrt;{__VUFNINFO__("_13_NumberPointer","int",927); VuxDbgBrkO() 
{
 VUXRSVB(1,1);    int ret = 0; VUXLV("int",ret,1);
 ...
 VUXRSVB(63,14);        unsigned int addr[6] = 
        {
            ...
            _0x1000016,
            _0x1000020
        }; VUXLV("unsigned int[6]",addr,14);

 VUXRSVB(64,15);        int a[6]; VUXLV("int[6]",a,15); VUXRS(65);
...
返回: 无意义
///////////////////////////////////////////////*/
int _14_CListTest(clist_t* pDatas)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"clist_t*","pDatas",(const void*)&pDatas}}; if(VuxMck("_14_CListTest",&vmckrt,vmckds,1,"",928,10,1)) return *(int*)vmckrt;{__VUFNINFO__("_14_CListTest","int",928); VuxDbgBrkO() 
{
...
///////////////////////////////////////////////*/
int _15_CallbackDefine(school_t* pSchool)
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"school_t*","pSchool",(const void*)&pSchool}}; if(VuxMck("_15_CallbackDefine",&vmckrt,vmckds,1,"",929,15,1)) return *(int*)vmckrt;{__VUFNINFO__("_15_CallbackDefine","int",929); VuxDbgBrkO() 
{
    /*[学习提示：自定义回调赋值]    在表格界面，选中行，右键菜单选择 新建回调赋值	详细说明，请参考帮助：测试数据之二(回调赋值)	*/
 VUXRSVB(1,1);    int i, j, k; VUXLV("int",i,1); VUXLVS("int",j,2); VUXLVS("int",k,3); VUXRS(2);
    for(i=0; VUXRS(4)&&( i< (6*10)); VUXRS(3), i++)
    {VUXRBR_LOOP2(1,2,69);{
 VUXRSVB(5,4);        class_t* pClass = pSchool->classes[i]; VUXLV("class_t*",pClass,4);
        if( VUXRS(6)&&(pClass != 0))
        {{ VUXRS(7);
            for(j =0; VUXRS(9)&&( j<42); VUXRS(8), j++)
            {VUXRBR_LOOP2(3,5,70);{
 VUXRSVB(10,5);                student_t* pStudent = pClass->students[j]; VUXLV("student_t*",pStudent,5);
                //小于30分，会唔家长
...
#include "VuxConn/Demo/_4T_DataBasic.cpp.h"

void _demo__4t_databasic_cpp_fps(void** cbfs, void** onfs, void** gvfs, int index)
{
