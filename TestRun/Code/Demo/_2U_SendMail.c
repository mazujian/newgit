...
#include "VuxMockFl/Demo/_2U_SendMail.c.h"
#include "VuxMock/Demo/_2U_SendMail.c"
...
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"char*","p_str",(const void*)&p_str},{2,"size_t","size",(const void*)&size}}; if(VuxMck("_01_read_mail_one2",&vmckrt,vmckds,2,"",1051,35,1)) return *(Mail**)vmckrt;{__VUFNINFO__("_01_read_mail_one2","Mail*",1051); VuxDbgBrkO() 
{
 ...
 VUXRSVB(5,6);    Mail* p_mail = (Mail*)malloc(sizeof(Mail)); VUXLV("Mail*",p_mail,6);
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"char**","pp_str",(const void*)&pp_str},{2,"char*","p_mail_text",(const void*)&p_mail_text},{3,"size_t","size",(const void*)&size}}; if(VuxMck("_02_read_mail_one_text2",&vmckrt,vmckds,3,"",1052,21,1)) return *(BOOL*)vmckrt;{__VUFNINFO__("_02_read_mail_one_text2","BOOL",1052); VuxDbgBrkO() 
{
...
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"char*","p_str",(const void*)&p_str},{2,"size_t","buf_size",(const void*)&buf_size}}; if(VuxMck("_03_read_mails2",&vmckrt,vmckds,2,"",1053,13,1)) return *(Mail**)vmckrt;{__VUFNINFO__("_03_read_mails2","Mail*",1053); VuxDbgBrkO() 
{
 ...
 VUXRSVB(3,3);    char mail_text[64]; VUXLVA("char[64]",mail_text,3);
    ...
    while( VUXRS(4)&&(*p_str))
    {VUXRBR_LOOP2(1,2,133);{
 VUXRS(5);        memset(mail_text, 0, sizeof(char)*64);
        //读取一个mail的字符串
        if( VUXRS(6)&&(_02_read_mail_one_text2(&p_str, mail_text, 64)))
        {{
            //解析成Mail对象指针
 VUXRSVB(7,4);            Mail* p_one_mail = _01_read_mail_one2(mail_text, 64); VUXLV("Mail*",p_one_mail,4);
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"char*","p_str",(const void*)&p_str},{2,"size_t","buf_size",(const void*)&buf_size},{3,"char**","pp_tail",(const void*)&pp_tail}}; if(VuxMck("_04_read_tail2",&vmckrt,vmckds,3,"",1054,18,1)) return *(size_t*)vmckrt;{__VUFNINFO__("_04_read_tail2","size_t",1054); VuxDbgBrkO() 
{
 VUXRSVB(1,1);    size_t i; VUXLV("size_t",i,1);
 VUXRSVB(2,2);    size_t count = 0; VUXLV("size_t",count,2);
...
{void* vmckrt=0; VMCKDS vmckds[1]={{1,"FILE*","p_file",(const void*)&p_file}}; if(VuxMck("_05_read_mails_from_file2",&vmckrt,vmckds,1,"",1084,38,1)) return *(Mail**)vmckrt;{__VUFNINFO__("_05_read_mails_from_file2","Mail*",1084); VuxDbgBrkO() 
{
 ...
 VUXRS(10);    p_buf = (char*)malloc(buf_size);
    if( VUXRS(11)&&(p_buf == 0))
    {{
 ...
 VUXRS(24);        offset = 0;
        ...
        {{
            ...
            {{
 VUXRS(28);                offset = _04_read_tail2(p_buf, buf_size, &p_tail);  
        ...
        //解析缓冲区中的mail列表
 VUXRS(30);        p_mail = _03_read_mails2(p_buf, buf_size);
 ...
 VUXRS(33);                p_mails = p_mail;
            ...
            {{
 VUXRS(34);                _09_add_to_tail2(p_prev, p_mail);
            }}
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"Mail*","p_mails",(const void*)&p_mails},{2,"char*","p_subject",(const void*)&p_subject},{3,"char*","p_content",(const void*)&p_content}}; if(VuxMck("_06_send_mail2",&vmckrt,vmckds,3,"",835,7,1)) return *(int*)vmckrt;{__VUFNINFO__("_06_send_mail2","int",835); VuxDbgBrkO() 
{
 ...
 VUXRS(6);    _10_free_mails2(p_mails);
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"char*","mail_path",(const void*)&mail_path},{2,"char*","p_subject",(const void*)&p_subject},{3,"char*","p_content",(const void*)&p_content}}; if(VuxMck("_07_send_mail_from_file2",&vmckrt,vmckds,3,"",836,11,1)) return *(int*)vmckrt;{__VUFNINFO__("_07_send_mail_from_file2","int",836); VuxDbgBrkO() 
{
 ...
 VUXRS(4);        {int __vurtv__= 0;VUXFRTY();}
    ...
    //打开文件
 VUXRS(5);    p_file = fopen(mail_path, "rb+");
    if( VUXRS(6)&&(p_file == 0))
...
/* //////////////////////////////////////////////
双向链表输入输出示例，功能同_06_send_mail2，使用双向链表
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"ListItem*","p_mails",(const void*)&p_mails},{2,"char*","p_subject",(const void*)&p_subject},{3,"char*","p_content",(const void*)&p_content}}; if(VuxMck("_08_send_mail2",&vmckrt,vmckds,3,"",837,6,1)) return *(int*)vmckrt;{__VUFNINFO__("_08_send_mail2","int",837); VuxDbgBrkO() 
{
...
{VMCKDS vmckds[2]={{1,"Mail*","p_mail",(const void*)&p_mail},{2,"Mail*","p_new",(const void*)&p_new}}; if(!VuxMck("_09_add_to_tail2",0,vmckds,2,"",838,8,1)) {__VUFNID__(838); VuxDbgBrkO() 
{
...
{VMCKDS vmckds[1]={{1,"Mail*","p_mail",(const void*)&p_mail}}; if(!VuxMck("_10_free_mails2",0,vmckds,1,"",839,5,1)) {__VUFNID__(839); VuxDbgBrkO() 
{
...
{void* vmckrt=0; VMCKDS vmckds[2]={{1,"int","arg",(const void*)&arg},{2,"char**","args",(const void*)&args}}; if(VuxMck("sm_main2",&vmckrt,vmckds,2,"",840,2,1)) return *(int*)vmckrt;{__VUFNINFO__("sm_main2","int",840); VuxDbgBrkO() 
{
 VUXRS(1);    _07_send_mail_from_file2(mail_path, mail_subject, mail_content);
 VUXRS(2);    {int __vurtv__= 0;VUXFRTY();}
}}}

#include "VuxConn/Demo/_2U_SendMail.c.h"

VUEXTERNC void _demo__2u_sendmail_c_fps(void** cbfs, void** onfs, void** gvfs, int index)
{
