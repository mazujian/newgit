...
#include "VuxMockFl/Demo/_6T_WhiteBox.cpp.h"
#include "VuxMock/Demo/_6T_WhiteBox.cpp"


CWhiteBox::CWhiteBox()
{__VUFNID__(1014); VuxDbgBrkO() 
{

}VUXFRTNE();}

CWhiteBox::~CWhiteBox()
{__VUFNID__(1015); VuxDbgBrkO() 
{
...
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"int","A",(const void*)&A},{2,"int","B",(const void*)&B},{3,"int","X",(const void*)&X}}; if(VuxMckM("_01_WhiteBox",&vmckrt,vmckds,3,"CWhiteBox",1016,7,1)) return *(int*)vmckrt;{__VUFNINFO__("_01_WhiteBox","int",1016); VuxDbgBrkO() 
{
...
{VMCKDS vmckds[2]={{1,"char*","pSrc",(const void*)&pSrc},{2,"char*","pDes",(const void*)&pDes}}; if(!VuxMckM("_02_DeleteComment",0,vmckds,2,"CWhiteBox",1017,37,1)) {__VUFNID__(1017); VuxDbgBrkO() 
{
...
返回: 如果判断为真，返回真，否则返回假
///////////////////////////////////////////////*/
BOOL CWhiteBox::_03_Mcdc1(BOOL A, BOOL B, BOOL C)
{void* vmckrt=0; VMCKDS vmckds[3]={{1,"BOOL","A",(const void*)&A},{2,"BOOL","B",(const void*)&B},{3,"BOOL","C",(const void*)&C}}; if(VuxMckM("_03_Mcdc1",&vmckrt,vmckds,3,"CWhiteBox",1063,5,1)) return *(BOOL*)vmckrt;{__VUFNINFO__("_03_Mcdc1","BOOL",1063); VuxDbgBrkO() 
{
...
返回: 如果判断为真，返回真，否则返回假
///////////////////////////////////////////////*/    
BOOL CWhiteBox::_04_Mcdc2(BOOL A, BOOL B, BOOL C, BOOL D, BOOL E, BOOL F, BOOL G, BOOL H, BOOL I, BOOL J, BOOL K)
{void* vmckrt=0; VMCKDS vmckds[11]={{1,"BOOL","A",(const void*)&A},{2,"BOOL","B",(const void*)&B},{3,"BOOL","C",(const void*)&C},{4,"BOOL","D",(const void*)&D},{5,"BOOL","E",(const void*)&E},{6,"BOOL","F",(const void*)&F},{7,"BOOL","G",(const void*)&G},{8,"BOOL","H",(const void*)&H},{9,"BOOL","I",(const void*)&I},{10,"BOOL","J",(const void*)&J},{11,"BOOL","K",(const void*)&K}}; if(VuxMckM("_04_Mcdc2",&vmckrt,vmckds,11,"CWhiteBox",1064,13,1)) return *(BOOL*)vmckrt;{__VUFNINFO__("_04_Mcdc2","BOOL",1064); VuxDbgBrkO() 
{
...
#include "VuxConn/Demo/_6T_WhiteBox.cpp.h"
