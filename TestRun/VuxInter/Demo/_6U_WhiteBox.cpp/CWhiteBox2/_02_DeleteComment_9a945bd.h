...
//VuxInter/Demo/_6U_WhiteBox.cpp/CWhiteBox2/_02_DeleteComment_9a945bd.h

//$$VUNIT(BEGIN,TESTFUNCPLUG/CWhiteBox2::_02_DeleteComment(char*,char*))
#ifdef _VUDEBUG
void CWhiteBox2::_02_DeleteComment_vpls_(char* pSrc,char* pDes){ VuxDbgBrkP()
{
    int len = strlen(pSrc);
...
#else
void CWhiteBox2::_02_DeleteComment_vpls_(char* pSrc,char* pDes){VUX_VARIABLE(2) __VUFNID__(0);VuxDbp(0,0,37);
{
...
void CWhiteBox2::_02_DeleteComment_vpls(char* pSrc,char* pDes)
{
	VuxIncRunTimes();
    if(VuxRateTesting()) {CWhiteBox2::_02_DeleteComment(pSrc,pDes); return;}
...
//$$VUNIT(END,TESTFUNCPLUG/CWhiteBox2::_02_DeleteComment(char*,char*))
