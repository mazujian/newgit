...
//VuxInter/Demo/_4U_DataBasic.cpp/_13_NumberPointer2_d23b6c4e.h

//$$VUNIT(BEGIN,TESTFUNCPLUG/_13_NumberPointer2(int,int))
#ifdef _VUDEBUG
static int _13_NumberPointer2_vpls_(int a,int b){ VuxDbgBrkP()
{
    int ret = 0;
...
#else
static int _13_NumberPointer2_vpls_(int a,int b){VUX_VARIABLE(3) VUX_VARIABLE(4)  __VUFNINFO__("_13_NumberPointer2","int",0);VuxDbp(0,0,81);
{
...
static int _13_NumberPointer2_vpls(int a,int b)
{
	VuxIncRunTimes();
    if(VuxRateTesting()) {return _13_NumberPointer2(a,b);}
	else if(VuxIsRepeatRun()) {return _13_NumberPointer2_vpls_(a,b);}

#ifdef _VUDEBUG
    {int vuxRet =  VuxIsDebugPlug() ? _13_NumberPointer2_vpls_(a,b) : _13_NumberPointer2(a,b);
#else
    {int vuxRet = _13_NumberPointer2_vpls_(a,b);
#endif
    TEST_ASSERT_RETURN("int", &vuxRet);
    VuxResetRunTimes();
    return vuxRet;}
}
//$$VUNIT(END,TESTFUNCPLUG/_13_NumberPointer2(int,int))
